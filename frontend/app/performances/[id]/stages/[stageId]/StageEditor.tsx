...
import { InstrumentIcon } from "@/components/stage/InstrumentIcon";
...
export default function StageEditor({ stageId, initialStage, instruments, participants, isAdmin }: Props) {
  ...
  // One palette entry: instruments and library equipment look the same.
  function paletteButton(instr: InstrumentInfo) {
